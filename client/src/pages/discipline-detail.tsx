                ...
                <div className="lg:col-span-2 flex flex-col space-y-6">
                    <Card className="p-6 flex-1 flex flex-col">
                        ...
                        <ScrollableHistoryChart
                            ...
                            xKey="date"
                            series={[
                                { key: "xp", label: "XP Gained", color: "hsl(var(--primary))", axis: "left" },
                                { key: "completion", label: "Completion", color: "hsl(var(--primary) / 0.7)", axis: "right" },
                            ]}
                            height={270}
                            rightAxis={{ domain: [0, 100], formatter: (value) => `${Math.round(value)}%` }}
                        />
                    </Card>
